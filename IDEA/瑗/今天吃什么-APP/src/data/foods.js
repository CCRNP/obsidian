export const FOODS = [
  ...
  { name: '牡丹楼', color: '#6B8DD6' },
  { name: '甜品店', color: '#D4A06A' },
  { name: '麻辣烫', color: '#E86A5F' },
  { name: '日料', color: '#6FCB9B' },
  { name: '氟利昂', color: '#B48AD9' },
]
...
export const QUIZ_SCORES = {
  spicy: { 火锅: 3, 麻辣烫: 3, 烤肉: 1, 氟利昂: 1 },
  sweet: { 甜品: 3, 日料: 1, 寿司: 1 },
  salty: { 烤肉: 3, 甜品店: 2, 面: 2, 氟利昂: 1 },
  lively: { 火锅: 3, 烤肉: 2, 氟利昂: 2, 麻辣烫: 1 },
  quiet: { 日料: 3, 寿司: 2, 面: 1, 西餐: 2 },
  casual: { 牡丹楼: 3, 披萨: 2, 甜品店: 2, 面: 1 },
  immediate: { 牡丹楼: 3, 甜品店: 2, 披萨: 2, 麻辣烫: 1 },
  medium: { 面: 2, 烤肉: 2, 氟利昂: 2, 火锅: 1 },
  patient: { 火锅: 3, 日料: 3, 寿司: 2, 烤肉: 2 },
  energetic: { 火锅: 2, 烤肉: 2, 甜品店: 2, 麻辣烫: 2 },
  calm: { 寿司: 3, 面: 2, 日料: 2, 牡丹楼: 1 },
  healing: { 甜品: 3, 面: 2, 甜品店: 1, 日料: 1 },
  taste: { 火锅: 3, 烤肉: 3, 麻辣烫: 2, 面: 2 },
  looks: { 寿司: 3, 日料: 3, 披萨: 2, 甜品: 2 },
  value: { 牡丹楼: 3, 甜品店: 2, 麻辣烫: 2,氟利昂: 2, 面: 1 },
}
